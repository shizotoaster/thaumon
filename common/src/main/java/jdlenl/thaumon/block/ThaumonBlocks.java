...
public class ThaumonBlocks {
    ...
    public static void init() {
        ...
        AMBERGLASS = registerBlock("amberglass",
                () -> new ThaumonGlassBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).sound(SoundType.SHROOMLIGHT).strength(1.0F).lightLevel(
                (state) -> 5
        ...
        GREATWOOD_DOOR = registerBlock("greatwood_door",
                () -> new ThaumonDoorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WARPED_HYPHAE).ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F).noOcclusion().isRedstoneConductor(
                (state, view, pos) -> false
        ), BlockSetType.OAK));

        GREATWOOD_TRAPDOOR = registerBlock("greatwood_trapdoor",
                () -> new ThaumonTrapDoorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WARPED_HYPHAE).ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F).noOcclusion().isRedstoneConductor(
                (state, view, pos) -> false
        ), BlockSetType.OAK));
        ...
        GREATWOOD_FENCE_GATE = registerBlock("greatwood_fence_gate",
                () -> new ThaumonFenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WARPED_HYPHAE).ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F).forceSolidOn(), WoodType.OAK));

        GREATWOOD_WINDOW = registerBlock("greatwood_window",
                () -> new ThaumonGlassBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WARPED_HYPHAE).instrument(NoteBlockInstrument.HAT).sound(SoundType.GLASS).strength(0.5F).noOcclusion().isRedstoneConductor(
                (state, view, pos) -> false
        )));
        ...
        SILVERWOOD_DOOR = registerBlock("silverwood_door",
                () -> new ThaumonDoorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F).noOcclusion().isRedstoneConductor(
                (state, view, pos) -> false
        ), BlockSetType.OAK));

        SILVERWOOD_TRAPDOOR = registerBlock("silverwood_trapdoor",
                () -> new ThaumonTrapDoorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F).noOcclusion().isRedstoneConductor(
                (state, view, pos) -> false
        ), BlockSetType.OAK));
        ...
        SILVERWOOD_FENCE_GATE = registerBlock("silverwood_fence_gate",
                () -> new ThaumonFenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F).forceSolidOn(), WoodType.OAK));
        ...
        ARCANE_STONE_WINDOW = registerBlock("arcane_stone_window",
                () -> new ThaumonGlassBlock(BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).instrument(NoteBlockInstrument.HAT).sound(SoundType.GLASS).strength(0.5F).noOcclusion().isRedstoneConductor(
                (state, view, pos) -> false
        )));
        ...
        ANCIENT_STONE_DOOR = registerBlock("ancient_stone_door",
                () -> new ThaumonDoorBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.BASALT).strength(4.0F, 10.0F).requiresCorrectToolForDrops(), BlockSetType.STONE));
        ...
        GREATWOOD_BUTTON = registerBlock("greatwood_button",
                () -> new ThaumonButtonBlock(BlockBehaviour.Properties.of().ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F), BlockSetType.OAK, 30));

        SILVERWOOD_BUTTON = registerBlock("silverwood_button",
                () -> new ThaumonButtonBlock(BlockBehaviour.Properties.of().ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F), BlockSetType.OAK, 30));

        ARCANE_STONE_BUTTON = registerBlock("arcane_stone_button",
                () -> new ThaumonButtonBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.DEEPSLATE).strength(3.0F, 7.0F).requiresCorrectToolForDrops(), BlockSetType.STONE, 20));

        ANCIENT_STONE_BUTTON = registerBlock("ancient_stone_button",
                () -> new ThaumonButtonBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.DEEPSLATE).strength(3.0F, 7.0F).requiresCorrectToolForDrops(), BlockSetType.STONE, 20));

        GREATWOOD_PRESSURE_PLATE = registerBlock("greatwood_pressure_plate",
                () -> new ThaumonPressurePlateBlock(BlockBehaviour.Properties.of().ignitedByLava().instrument(NoteBlockInstrument.BASS).sound(SoundType.CHERRY_WOOD).strength(2.0F, 3.0F).forceSolidOn(), BlockSetType.OAK));
        ...
        ARCANE_STONE_PRESSURE_PLATE = registerBlock("arcane_stone_pressure_plate",
                () -> new ThaumonPressurePlateBlock(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.DEEPSLATE).strength(3.0F, 7.0F).requiresCorrectToolForDrops().forceSolidOn(), BlockSetType.IRON));
